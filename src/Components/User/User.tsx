...
const User: React.FC = () => {
  ...
  if (!userData || !usersList)
    return (
      <div className="mx-auto py-4 w-max">
    ...
    return (
      <div className="container min-h-92.5-screen mx-auto p-4">
        <div className="container mx-auto h-max p-10 mt-10 bg-white rounded-md shadow">
          <h1 className="mb-2">
            Name: <span className="font-bold">{userData.displayName}</span>
          </h1>
          <h1 className="mb-2">
            Best Score: <span className="font-bold">{userData.score}</span>
          </h1>
          <h1 className="mb-2">
            Rank:{" "}
          ...
          <div>
            ...
            {confirm && (
              <div className="w-full h-full fixed left-0 top-0 z-100 flex flex-col items-center justify-center bg-opacity-25 bg-black">
                <div
                  ref={confirmRef}
                  className="w-max h-max flex flex-col items-center rounded-md justify-center bg-white p-20"
                >
                  <h1 className="text-xl">Confirm Deletion</h1>
                  <p className="text-sm">
                    Are you sure you want to delete this account? You will not
