        ...
        return (
            <div className='w-full mt-4' >
                <div className='flex' >
                    <select 
                    onChange={handleSort} 
                    className='text-xs cursor-pointer select-none p-1 mr-3 rounded outline-none border text-gray-400 focus-within:text-black hover:text-black' >
                    ...
                    <div className="relative text-xs text-gray-400 focus-within:text-black hover:text-black">
                        ...
                        <input id="searchpokemon" type="search" name="q" value={search} className="text-xs py-2 pl-10 outline-none rounded border text-gray-900 w-full" placeholder="Enter Pokemon Name..." autoComplete="off" onChange={handleSearch} />
                    </div>
                </div>
