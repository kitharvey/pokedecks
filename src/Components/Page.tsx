                ...
                <div className="fixed p-3 top-0 left-0 w-full flex items-center justify-between z-10" style={{background: "#ef233c"}}>
                    ...
                    <div className="">
                        ...
                        <div className="relative text-gray-400 focus-within:text-gray-900">
                            ...
                            <input id="searchpokemon" type="search" name="q" className="py-2 text-sm pl-10 focus:outline-none bg-white text-gray-900" placeholder="Search Pokemon..." autoComplete="off" onChange={handleSearch} />
                        </div>
                        </form>
                    </div>
                </div>
