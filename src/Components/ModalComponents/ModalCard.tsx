...
const ModalCard: React.FC = () => {
    ...
    return (
        <div ref={nmodalRef} className="relative h-max w-full rounded-md m-auto flex flex-col items-center justify-evenly bg-white p-4 shadow lg:flex-row" >
            <div className="h-8 w-8 absolute top-3 right-4 cursor-pointer transition duration-100 ease-in-out hover:opacity-50 text-4xl font-black" onClick={handleCloseModal} >
                <RiCloseCircleFill />
            </div>
